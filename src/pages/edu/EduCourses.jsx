        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <Reveal delay={0.04}>
            <div className="rounded-lg border border-white/10 bg-black p-5">
              ...
              <p className="text-2xl font-bold font-mono tabular-nums text-zinc-50">{maxWork}h<span className="text-sm text-white/40">/week</span></p>
              <p className="text-[11px] text-white/40 mt-1">Suggested max part-time hours</p>
              <div className="mt-3 grid grid-cols-3 gap-2 text-center">
                <Mini label="Study" value={`${totalStudy}h`} />
                <Mini label="Class" value={`${classHours}h`} />
                <Mini label="Sleep" value={`${sleep}h`} />
              </div>
            </div>
          </Reveal>
        </div>

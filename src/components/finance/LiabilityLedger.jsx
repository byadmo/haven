                ...
                {history.length === 0 ? (
                  ...
                  history.map((p) => (
                    <div key={p.id} className="group flex items-center gap-2 px-2 py-1.5 hover:bg-white/5">
                      ...
                      {!isFuture && (
                        <button onClick={() => removePayment(p)} className="h-5 w-5 flex items-center justify-center text-white/30 hover:text-rose-400 hover:bg-rose-500/10 opacity-0 group-hover:opacity-100 transition-opacity" aria-label="Delete payment">
